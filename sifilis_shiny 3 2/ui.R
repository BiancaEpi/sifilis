...
# gestantes ---------------------------------------------------------------
    ...
    tabPanel("Sífilis em Gestantes",
             fluidPage(
                 ...
                 hr(),
                 fluidRow(
                   column(width = 6, echarts4rOutput("trat_parceiro", height = 300)),
                   column(width = 6, echarts4rOutput("esquema_parceiro", height = 300))),
...
tabPanel("Outras análises",
         fluidPage(
             ...
             fluidRow(
               column(width = 4, 
                      selectInput("regiao_saude", "Selecione a Região de Saúde:",
                                  choices = NULL))),
