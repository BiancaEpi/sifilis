...
# congênita ---------------------------------------------------------------
    ...
    tabPanel("Sífilis Congênita",
             fluidPage(
                 ...
                 fluidRow(
                     column(width = 6, echarts4rOutput("reg_saude_plot", height = 400)),
                     column(width = 6, DTOutput("reg_saude_tab", height = 400))),
                 fluidRow(
...
# gestantes ---------------------------------------------------------------
    ...
    tabPanel("Sífilis em Gestantes",
             fluidPage(
                 ...
                 fluidRow(
                     column(width = 6, echarts4rOutput("faixa_etaria_gestante", height = 300)),
                     column(width = 6, echarts4rOutput("escola_gestante", height = 300))),
