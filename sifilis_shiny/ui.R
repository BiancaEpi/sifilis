...
# adquirida ---------------------------------------------------------------
    ...
    tabPanel("Sífilis Adquirida",
             fluidPage(
                 fluidRow(
                     column(width = 4,
                            selectInput("ano_adquirida", "Ano epidemiológico:", 
                                        ...
                                        selected = max(adquirida$ano_epi)) 
                 ...
                 fluidRow(
                     column(width = 12,
                            echarts4rOutput("adquirida_plot", height = 300)
                     )
                 ),
                 ...
                 fluidRow(
                     column(width = 12,
                            echarts4rOutput("regiao_adquirida", height = 400)
                     )
                 ),
...
# congênita ---------------------------------------------------------------
    ...
    tabPanel("Sífilis Congênita",
             fluidPage(
                 fluidRow(
                     column(width = 4,
                            selectInput("filtro3", "Ano epidemiológico",
                 ...
                 fluidRow(
                     column(width = 12,
                            echarts4rOutput("congenita_plot", height = 300)
                     )
                 ),
                 ...
                 fluidRow(
                     column(width = 6, echarts4rOutput("evolucao_congenita", height = 300)),
...
# gestantes ---------------------------------------------------------------
    ...
    tabPanel("Sífilis em Gestantes",
             fluidPage(
                 fluidRow(
                     column(width = 4,
                            selectInput("filtro4", "Filtro 4", choices = unique(gestante$mes_diag))
                     )
                 ),
                 fluidRow(
                     column(width = 12,
                            echarts4rOutput("gestante_plot", height = 300)
                     )
                 )
             ))
)